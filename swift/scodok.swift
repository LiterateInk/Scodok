...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_scodok_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_scodok_rustbuffer_free(self, $0) }
    }
}
...
open class Session:
    ...
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_scodok_fn_clone_session(self.pointer, $0) }
    }
public convenience init(instanceUrl: String, phpSessId: String) {
    let pointer =
        try! rustCall() {
    uniffi_scodok_fn_constructor_session_new(
    ...
    deinit {
        ...
        try! rustCall { uniffi_scodok_fn_free_session(pointer, $0) }
    }
...
public struct FfiConverterTypeError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Error {
        ...
        case 1: return .InvalidRedirection
        case 2: return .InvalidCasTicket
 ...
 */
public func getCasUrl(instanceUrl: String)async throws  -> String {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_scodok_fn_func_get_cas_url(FfiConverterString.lower(instanceUrl)
                )
            },
            pollFunc: ffi_scodok_rust_future_poll_rust_buffer,
            completeFunc: ffi_scodok_rust_future_complete_rust_buffer,
            freeFunc: ffi_scodok_rust_future_free_rust_buffer,
 ...
 */
public func getProfilePictureBytes(session: Session, nip: String?)async throws  -> Data {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_scodok_fn_func_get_profile_picture_bytes(FfiConverterTypeSession.lower(session),FfiConverterOptionString.lower(nip)
                )
            },
            pollFunc: ffi_scodok_rust_future_poll_rust_buffer,
            completeFunc: ffi_scodok_rust_future_complete_rust_buffer,
 ...
 */
public func getSessionFromCasTicket(instanceUrl: String, ticket: String)async throws  -> Session {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_scodok_fn_func_get_session_from_cas_ticket(FfiConverterString.lower(instanceUrl),FfiConverterString.lower(ticket)
                )
            },
            pollFunc: ffi_scodok_rust_future_poll_pointer,
            completeFunc: ffi_scodok_rust_future_complete_pointer,
            freeFunc: ffi_scodok_rust_future_free_pointer,
            liftFunc: FfiConverterTypeSession.lift,
            errorHandler: FfiConverterTypeError.lift
        )
}
public func getSessionFromToken(instanceUrl: String, token: String)async throws  {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_scodok_fn_func_get_session_from_token(FfiConverterString.lower(instanceUrl),FfiConverterString.lower(token)
                )
            },
            pollFunc: ffi_scodok_rust_future_poll_void,
            completeFunc: ffi_scodok_rust_future_complete_void,
            freeFunc: ffi_scodok_rust_future_free_void,
            liftFunc: { $0 },
            errorHandler: FfiConverterTypeError.lift
        )
}
 ...
 */
public func getUserStatus(session: Session, email: String)async throws  -> UserStatus {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_scodok_fn_func_get_user_status(FfiConverterTypeSession.lower(session),FfiConverterString.lower(email)
                )
            },
            pollFunc: ffi_scodok_rust_future_poll_rust_buffer,
            completeFunc: ffi_scodok_rust_future_complete_rust_buffer,
            freeFunc: ffi_scodok_rust_future_free_rust_buffer,
            liftFunc: FfiConverterTypeUserStatus.lift,
            errorHandler: FfiConverterTypeError.lift
        )
}
...
private var initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_scodok_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_scodok_checksum_func_get_cas_url() != 18301) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_scodok_checksum_func_get_profile_picture_bytes() != 22405) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_scodok_checksum_func_get_session_from_cas_ticket() != 18687) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_scodok_checksum_func_get_session_from_token() != 34578) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_scodok_checksum_func_get_user_status() != 19424) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_scodok_checksum_constructor_session_new() != 52659) {
        return InitializationResult.apiChecksumMismatch
    }
